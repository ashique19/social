    ...
    <div class="comment {if $_is_reply}reply{/if}" data-id="{$_comment['comment_id']}" id="comment_{$_comment['comment_id']}">
        ...
        <div class="comment-data">
            ...
            <ul class="comment-actions clearfix">
                ...
                <!-- comment -->
                <li>
                    <span class="text-link js_reply {if $post['comments_disabled']}x-hidden{/if}" data-username="{if $user->_data['user_name'] != $_comment['author_user_name']}{$_comment['author_user_name']}{/if}">
                        {__("Reply")}
                    </span>
                </li>
                <!-- comment -->
