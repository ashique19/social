...
<div class="post-header">
    ...
    <div class="post-meta">
        ...
        <div class="post-time">
            ...
            {/if}
            - 
            {if !$_shared && $_post['manage_post'] && $_post['user_type'] == 'user' && !$_post['in_group'] && !$_post['in_event'] && $_post['post_type'] != "product" && $_post['post_type'] != "article" && $_post['post_type'] != "profile_picture" && $_post['post_type'] != "profile_cover"}
                <!-- privacy -->
                {if $_post['privacy'] == "me"}
...
{elseif $_post['post_type'] == "video" && $_post['video']}
    <div>
        <video id="video-{$_post['video']['video_id']}" class="js_fluidplayer" onplay="update_media_views('video', {$_post['video']['video_id']})" {if $_post['video']['thumbnail']}poster="{$system['system_uploads']}/{$_post['video']['thumbnail']}"{/if} style="width:100%;height:100%;" width="100%" height="100%" control preload="auto">
