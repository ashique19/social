    ...
    <div class="card-header with-icon">
        {if $sub_view == ""}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/custom_fields/add" class="btn btn-sm btn-primary">
                    <i class="fa fa-plus mr5"></i>{__("Add New Field")}
                </a>
            </div>
        {else}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/custom_fields" class="btn btn-sm btn-light">
                    ...
                    <tbody>
                        {foreach $rows as $row}
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/custom_fields/edit/{$row['field_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
        ...
        <form class="js_ajax-forms " data-url="admin/custom_fields.php?do=add">
            <div class="card-body">
                ...
                <div id="js_field-select-options" class="x-hidden">
                    <div id="js_field-select-options" class="form-group form-row">
                        <label class="col-md-3 form-control-label">
                            {__("Select Options")}
                        </label>
                        <div class="col-md-9">
