    ...
    <div class="card-header with-icon">
        {if $sub_view == ""}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/packages/add" class="btn btn-sm btn-primary">
                    <i class="fa fa-plus mr5"></i>{__("Add New Package")}
                </a>
            </div>
        {elseif $sub_view == "add" || $sub_view == "edit"}
            <div class="float-right">
                <a href="{$system['system_url']}/admincp/packages" class="btn btn-sm btn-light">
    ...
    {if $sub_view == ""}
        ...
        <div class="card-body">
            <div class="alert alert-warning">
                ...
                <div class="text pt5">
                    {__("Make sure you have configured")} <a class="alert-link" href="{$system['system_url']}/admincp/settings/payments">{__("Payments Settings")}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        {foreach $rows as $row}
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/admincp/packages/edit/{$row['package_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
