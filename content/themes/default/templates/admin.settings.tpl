            ...
            <div class="tab-pane" id="Features">
                <form class="js_ajax-forms " data-url="admin/settings.php?edit=features_settings">
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            <div>
                                <div class="form-control-label h6">{__("Cookie Consent")}</div>
            ...
            <div class="tab-pane active" id="General">
                <form class="js_ajax-forms " data-url="admin/settings.php?edit=registration">
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            <div>
                                <div class="form-control-label h6">{__("Delete Account")}</div>
                        ...
                        <div class="form-table-row">
                            <div>
                                <div class="form-control-label h6">{__("Download User Information")}</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-table-row">
                            <div>
                                ...
                                <div class="form-text d-none d-sm-block">{__("Enable Amazon S3 storage")}</div>
                            </div>
                            <div class="text-right">
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-9">
                                <select name="s3_region" class="form-control">
                                    ...
                                    <option value="cn-north-1" {if $system['s3_region'] == "cn-north-1"}selected{/if}>China (Beijing)</option>
                                    <option value="cn-northwest-1" {if $system['s3_region'] == "cn-northwest-1"}selected{/if}>China (Ningxia)</option>
