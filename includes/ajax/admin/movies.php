...
try {
	...
	switch ($_GET['do']) {
		case 'add_movie':
			...
			/* return */
			return_json( array('callback' => 'window.location = "'.$system['system_url'].'/admincp/movies";') );
			break;
		...
		case 'add_genre':
			/* insert */
			$db->query(sprintf("INSERT INTO movies_genres (genre_name, genre_description) VALUES (%s, %s)", secure($_POST['genre_name']), secure($_POST['genre_description']) )) or _error("SQL_ERROR_THROWEN");
			/* return */
			return_json( array('callback' => 'window.location = "'.$system['system_url'].'/admincp/movies/genres";') );
			break;
		...
		case 'edit_genre':
			...
			/* update */
			$db->query(sprintf("UPDATE movies_genres SET genre_name = %s, genre_description = %s WHERE genre_id = %s", secure($_POST['genre_name']), secure($_POST['genre_description']), secure($_GET['id'], 'int') )) or _error("SQL_ERROR_THROWEN");
			/* return */
